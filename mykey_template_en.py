# ══════════════════════════════════════════════════════════════════════════════
#  G-Agent — mykey.py configuration template (copy to mykey.py and fill in)
# ══════════════════════════════════════════════════════════════════════════════
#
#  Quick start:
#    1. Copy this file to mykey.py
#    2. Uncomment one of the configs below and fill in your apikey
#    3. Run `python -m g_agent.agent` or `g-agent fs / wechat / tg`
#
#  G-Agent auto-detects any variable whose name contains 'api'/'config'/'cookie'
