        ...
        out.append(
            {
                ...
                "safety": {
                    "autonomous_safe": s.autonomous_safe,
                    "blast_radius": s.blast_radius,
                    "requires_credentials": s.requires_credentials,
                    "data_exposure": s.data_exposure,
                    "effect_scope": s.effect_scope,
                },
...
def main():
    parser = argparse.ArgumentParser(
        prog="skill_search", description="Skill 检索系统 — 根据环境和需求智能推荐 skill（API 客户端）"
    )
    ...
    if args.env:
        ...
        print(
            f"  模型能力: tool_calling={env['model']['tool_calling']}, "
