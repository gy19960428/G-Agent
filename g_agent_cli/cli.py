"""
g_agent_cli/cli.py - G-Agent 命令行分发系统
...
COMMANDS = {
    "fs": {
        "help": "启动飞书前端 (fsapp)",
        "desc": "启动飞书 Bot 前端（fsapp.py）",
        "cmd": ["python", "{FRONTENDS}/fsapp.py"],
    },
    "wechat": {
        "help": "启动微信前端 (wechatapp)",
        "desc": "启动微信 Bot 前端（wechatapp.py）",
        "cmd": ["python", "{FRONTENDS}/wechatapp.py"],
    },
    "tg": {
        "help": "启动 Telegram 前端 (tgapp)",
        "desc": "启动 Telegram Bot 前端（tgapp.py）",
    ...
    "launcher": {
        "help": "启动 Launcher 管理面板",
        "desc": "启动前端管理面板（系统托盘 + 浏览器界面）",
        "cmd": ["python", "{PROJECT_DIR}/launcher.pyw"],
    },
    "cli": {
        "help": "启动 CLI 对话",
        "desc": "启动命令行交互对话模式，最轻量的使用方式",
        "cmd": ["python", "-m", "g_agent.agent"],
    },
    "status": {
        "help": "检查运行状态",
        "desc": "检查当前是否已有 G-Agent 进程在运行",
        "cmd": None,
        "internal": True,
    },
    "update": {
