...
class BrowserDriver:
    ...
    def _remote_cmd(self, cmd):
        try:
            ...
            raise ConnectionError("BrowserDriver master未运行，看 browser_driver_sop 启动 master")
    ...
    def set_session(self, url_pattern: str) -> bool:
        ...
        if not matched:
            return print(f"警告: 未找到URL包含 '{url_pattern}' 的会话")
        if len(matched) > 1:
...
if __name__ == "__main__":
    driver = BrowserDriver(host="127.0.0.1", port=18765)
