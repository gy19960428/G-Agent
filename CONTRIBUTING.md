# Contributing to G-Agent

## Why This File Is Short

G-Agent's core is ~3K lines. Every file in this repo will be read by AI agents — potentially thousands of times. Extra words cost real tokens and push useful context out of the window, increasing hallucinations. This document practices what it preaches: **say only what matters.**
...
G-Agent evolves through skills. Not all skills belong in the core repo:
